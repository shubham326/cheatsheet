...
----------------------------------------crud operations-----------------------------------------------
    ...
    #views.py    
    def success(request):
        return render(request, 'app.html')                              #here 'app.html' is the page where u want to redirect the url after save
    ...
    if request.method=='POST':                                          #To check method==POST,GET,PATCH,PUT,DELETE
        ...
        if fm.is_valid():                                               #To validate data
            ...
            print('Email:', Email)
            #fm = students()
            return HttpResponseRedirect('/app/success/')               #here '/app/success/' is the url which u want to see in your url
    else:
        fm = students()
...
----------------------------------------django Form-----------------------------------------------
    ...
    #manly uses for specific field validation
    #forms.py
    from django import forms
    class student(forms.Form):
        name = forms.CharField()
    ...
    #specific filed cleaned validation
        def clean_name(self):
    ...
    #cleaned method validation
        #def clean(self):
            ...
            #    raise forms.ValidationError('Enter more than or equal to 4 char')
            #if len(val_email) < 10:
            #    raise forms.ValidationError('Enter more than or equal to 10 char')
